...
tellraw @a [{"text":"[ ","color":"gray","bold":false},{"selector":"@a[tag=p2]","color":"dark_green","bold":true},{"text":" completed the pattern!","color":"white","bold":false},{"text":" ]","color":"gray","bold":false}]
