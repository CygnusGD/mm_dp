...
tellraw @a[tag=!in_solo_game] [{"text":"[ ","color":"gray","bold":false},{"selector":"@a[tag=p3]","color":"dark_green","bold":true},{"text":" completed the pattern!","color":"white","bold":false},{"color":"dark_green","text":" ("},{"color":"dark_green","score":{"name":"@a[tag=p3,limit=1]","objective":"personal_timer_seconds"}},".",{"color":"dark_green","score":{"name":"@a[tag=p3,limit=1]","objective":"personal_timer_tenths"}},{"color":"dark_green","score":{"name":"@a[tag=p3,limit=1]","objective":"personal_timer_hundredths"}},{"color":"dark_green","text":"s"},{"color":"dark_green","text":")"},{"text":" ]","color":"gray","bold":false}]
