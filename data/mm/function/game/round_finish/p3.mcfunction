...
tellraw @a[tag=!in_solo_game] [{"text":"[ ","color":"gray","bold":false},{"selector":"@a[tag=p3]","color":"dark_green","bold":true},{"text":" completed the pattern!","color":"white","bold":false},{"text":" ]","color":"gray","bold":false}]
