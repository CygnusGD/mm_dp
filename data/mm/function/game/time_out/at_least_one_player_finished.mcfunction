...
execute as @a if score @s lives matches ..0 run tag @s remove alive
execute as @a if score @s lives matches ..0 run tag @s add spectator
execute as @a[gamemode=!spectator] if score @s lives matches ..0 run scoreboard players remove $living_players data 1
execute as @a if score @s lives matches ..0 run gamemode spectator

#if there are 2 or more living players, start another round
execute if score $living_players data matches 2.. run title @a subtitle ""
execute if score $living_players data matches 2.. run title @a title {"text":"Starting Next Round","color":"#007D28"}
execute if score $living_players data matches 2.. unless score @s lives matches ..1 run title @a[tag=!round_finish] title {"text":"You lost a life!","color":"#DD2800"}
execute if score $living_players data matches 2.. if score @s lives matches ..1 run title @a[tag=!round_finish] title {"text":"You were eliminated!","color":"#DD2800"}
execute as @a[tag=!round_finish] at @s if score $living_players data matches 2.. run playsound minecraft:entity.lightning_bolt.thunder master @s ~ ~ ~

#if there is 1 living player, end the game cause somebody won
execute as @a[tag=alive,limit=1] at @s if score $living_players data matches 1 run function mm:game/finish_game
