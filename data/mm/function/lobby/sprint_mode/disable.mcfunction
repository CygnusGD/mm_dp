...
setblock -1 63 12 oak_wall_sign[facing=north]{front_text:{color:"white",has_glowing_text:1b,messages:[{text:""},{text:"Sprint Mode:",click_event:{action:"run_command",command:"/function mm:lobby/sprint_mode/enable"}},{text:"Off"},{text:""}]}} replace
