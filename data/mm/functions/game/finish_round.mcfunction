...
#tell everybody who ~~got eliminated~~ lost a life
...
execute if score $living_players data matches 2.. run title @a[tag=!round_finish] title {"text":"You lost a life!","color":"#DD2800"}
